export default {
    ...
    return fetch('https://parks-p3.firebaseio.com/parks/' + url.url.name+".json", fetchSettings).then((response) => {
      return response.json();
  ...
  viewAllFavorites: function(){
    ...
    return fetch('https://parks-p3.firebaseio.com/parks.json', fetchSettings).then((response) => {
      return response.json();
    });
  },
  ...
  delPark: function(name){
    ...
    return fetch('https://parks-p3.firebaseio.com/parks/'+ name.url.name +'.json', fetchSettings).then((response) => {
      return response.json();
    });
  },
  ...
  updatePark(name, comment){
    console.log("comment", comment);
      ...
      fetch('https://parks-p3.firebaseio.com/parks/'+ name.url.name + '.json', fetchSettings).then((response) => {
        return response.json();
      });
    }
}
